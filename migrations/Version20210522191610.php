 ...
 */
final class Version20210522191610 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE club (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, adresse2 VARCHAR(255) DEFAULT NULL, cp INT NOT NULL, ville VARCHAR(255) NOT NULL, tel INT DEFAULT NULL, adresse1 VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE licencie (id INT AUTO_INCREMENT NOT NULL, uncompte_id INT DEFAULT NULL, unclub_id INT NOT NULL, unequalite_id INT NOT NULL, numlicenceunique INT NOT NULL, mail VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, adresse1 VARCHAR(255) NOT NULL, adresse2 VARCHAR(255) DEFAULT NULL, cp VARCHAR(5) NOT NULL, ville VARCHAR(255) NOT NULL, tel INT DEFAULT NULL, date_adhesion DATE NOT NULL, UNIQUE INDEX UNIQ_3B7556123F100910 (uncompte_id), INDEX IDX_3B7556126529F5F1 (unclub_id), INDEX IDX_3B755612DF6E17F (unequalite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
